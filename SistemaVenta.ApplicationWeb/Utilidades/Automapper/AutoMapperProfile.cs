...
namespace SistemaVenta.ApplicationWeb.Utilidades.Automapper
{
	public class AutoMapperProfile: Profile
	{
		public AutoMapperProfile()
		{
			...
			CreateMap<VMVenta, Venta>()
				.ForMember(destino =>
					destino.SubTotal,
					opt => opt.MapFrom(origen => Convert.ToDecimal(origen.SubTotal.Value, new CultureInfo("es-AR")))
				)
				.ForMember(destino =>
					destino.ImpuestoTotal,
					opt => opt.MapFrom(origen => Convert.ToDecimal(origen.ImpuestoTotal.Value, new CultureInfo("es-AR")))
				)
				.ForMember(destino =>
					destino.Total,
